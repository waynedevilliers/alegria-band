    ...
    <div className="mx-auto max-w-7xl">
      <div className="rounded-[2rem] bg-cream p-8 shadow-soft sm:p-10 ring-2 ring-sangria ring-offset-4 ring-offset-cream">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2 lg:items-center">
          {/* Photo */}
          <div className="relative overflow-hidden rounded-lg shadow-md ring-2 ring-sangria ring-offset-4 ring-offset-cream transition-all duration-300 hover:shadow-lg hover:scale-105" style={{ aspectRatio: '800/590' }}>
            <Image
